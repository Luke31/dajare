...
from dajare.train import ModelTrainer
from dajare.train import main
from dajare.train import read_data
...
@patch.object(sys, 'argv', ['train',
                            ...
                            'tmpvalidpickle.pkl',
                            'header'])
@patch.object(dajare.pipeline, 'features',
              ['sepal length (cm)', 'sepal width (cm)',
               'petal length (cm)', 'petal width (cm)'])
@patch('dajare.pipeline.init_pipeline')
@patch('dajare.train.read_data')
